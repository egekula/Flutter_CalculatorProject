...
import 'package:mini_calculator/button_values.dart';
...
class _MiniCalculatorState extends State<MiniCalculator> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("Mini Calculator",style: TextStyle(fontFamily: "headerFont",fontSize: 30,fontWeight: FontWeight.bold),),
